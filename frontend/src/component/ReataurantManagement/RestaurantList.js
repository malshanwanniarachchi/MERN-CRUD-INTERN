    ...
    <div id="mainDiv" className="container">
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="addRestaurantModalLabel">Add Customer</h5>
              <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div className="modal-body">
              <form className="row g-3" onSubmit={onSubmitForm} id="formSubject">
                <div className="col-auto">
                  <label htmlFor="inputText2" className="visually-hidden">Customer Name</label>
                  <input type="text" className="form-control" id="inputText2" placeholder="Enter Customer Name"
                    name="Name"
                    value={formData.Name}
                ...
                <div className="col-auto">
                  ...
                  <input type="text" className="form-control" id="inputText2" placeholder="Enter Customer Address"
                    name="Address"
                    value={formData.Address}
                    onChange={handleChange} />
                </div>
                <div className="col-auto">
                  <label htmlFor="inputText2" className="visually-hidden">Mobile No.</label>
      ...
      <div className="modal fade" id="editRestaurantModal" tabIndex="-1" aria-labelledby="editRestaurantModalLabel" aria-hidden="true">
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="editRestaurantModalLabel">Edit Customer Details</h5>
              <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div className="modal-body">
              <form className="row g-3" onSubmit={onSubmitEditForm} id="formEdit">
                <div className="col-auto">
                  <label htmlFor="editText2" className="visually-hidden">Customer Name</label>
                  <input type="text" className="form-control" id="editText2" placeholder="Update Customer Name"
                    name="Name"
                ...
                <div className="col-auto">
                  ...
                  <input type="text" className="form-control" id="editText2" placeholder="Update Address"
                    name="Address"
                ...
                <div className="col-auto">
                  ...
                  <input type="text" className="form-control" id="editText2" placeholder="Update Telephone"
                    name="Telephone"
      ...
      <div className='container' id="RestaurantContainer">
        <h1 id="title">Dine Hub Restaurant</h1>
        ...
        <table id="list" className='table table-hover'>
          <thead>
            <tr>
              ...
              <th id="header" scope='col'>Customer Name</th>
